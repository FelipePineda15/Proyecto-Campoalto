...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-04-2018 a las 03:41:00
...
CREATE TABLE `estudiante` (
  ...
  `Huella_Dactilar` int(11) DEFAULT NULL,
  `No_Carné` int(11) DEFAULT NULL
...
INSERT INTO `estudiante` (`ID_Estudiante`, `Documento`, `Nombres`, `Apellidos`, `Direccion`, `Telefono`, `Celular`, `Email`, `ID_Programa`, `ID_Semestre`, `Huella_Dactilar`, `No_Carné`) VALUES
(9, 1019120851, 'Jose', 'Saramago', 'Cll 5 # 15-96', 6658989, 305305305, 'jjj@gmil.com', 1, 1, NULL, 1),
(10, 52589947, 'Enrique', 'Peña', 'Kr 15 # 35-64', 3026969, 320320320, 'ffff@gmail.com', 2, 2, NULL, 2),
(11, 111111, 'Mario', 'Neta', 'cl 52', 56656, 11112123, 'hgdfh@gjfmf.com', 3, 2, NULL, 3),
(12, 2222222, 'Susana', 'Oria', 'cl 89', 5645454, 2147483647, 'fgfdfhdfh@fhgj.com', 4, 1, NULL, 4),
(13, 546454546, 'Elba', 'Calao', 'Cl 142', 455854874, 2147483647, 'hdfbdfdfj@ggg.com', 5, 2, NULL, 5),
(14, 548747, 'Soila', 'Cerda', 'tv 486', 2156454, 5614522, 'hjige@kgfjkgfjgf.com', 6, 2, NULL, 6);
...
INSERT INTO `semestre` (`ID_Semestre`, `Numero_Semestre`, `Valor_Semestre`, `Estado`) VALUES
(1, 1, 1, '1'),
(2, 2, 1, '2');
